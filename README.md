...
| | Status |
|---|---|
| `packages/domain` — the rules | **126 tests, 93%+ coverage.** Analyzer clean. |
| `lib/` — the Flutter app | **93 tests.** Gate, Front Desk, Office Rules, Blocklist, Guardian, platform repository. |
